          ...
          <CardContent className="space-y-6">
            {additionalUsers > 0 ? (
              <>
                ...
                <div className="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-lg p-6">
                  <div className="flex items-center space-x-3 mb-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-orange-800 text-lg">決済が必要です</h3>
                      <p className="text-sm text-orange-700">
                        {additionalUsers}人分の追加料金が発生しています
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center py-2 border-b border-gray-200">
                      ...
                      <span className="font-semibold">10人まで</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-gray-200">
                      <span className="text-gray-600">超過人数</span>
                      <Badge variant="destructive" className="text-sm">{additionalUsers}人</Badge>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-gray-200">
                      <span className="text-gray-600">単価</span>
                      <span className="font-semibold">¥500/人/月</span>
                    </div>
                    <div className="flex justify-between items-center py-3 bg-blue-50 rounded-lg px-3">
                      <span className="text-lg font-semibold text-blue-900">合計金額</span>
                  ...
                  >
                    {isProcessing ? (
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <span>¥{additionalCost.toLocaleString()}を決済する</span>
                      </div>
                    )}
                  </Button>
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-8 text-center">
                ...
                <h3 className="font-semibold text-green-800 text-xl mb-2">決済は不要です</h3>
                <p className="text-green-700">
                  現在の利用者数（{userCount}人）は無料枠内です
                </p>
              </div>
            )}
          </CardContent>
