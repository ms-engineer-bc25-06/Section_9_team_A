...
export function MemberDetail({ memberId }: Props) {
  ...
  const profileItems = [
    { icon: Calendar, label: "入社年月", value: member.joinDate },
    { icon: Calendar, label: "生年月日", value: member.birthDate },
    ...
    { icon: Trophy, label: "学生時代の部活／サークル", value: member.club },
    { icon: Utensils, label: "好きな食べ物", value: member.favoriteFood },
    { icon: Coffee, label: "休日の過ごし方", value: member.weekendActivity },
  ]
