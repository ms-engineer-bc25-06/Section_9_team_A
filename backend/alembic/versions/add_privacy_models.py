...
def upgrade() -> None:
    ...
    op.execute("CREATE TYPE privacylevel AS ENUM ('public', 'team', 'private', 'confidential')")
    op.execute("CREATE TYPE datacategory AS ENUM ('profile', 'analysis', 'goals', 'progress', 'communication', 'performance', 'personal')")
    
    # 暗号化データテーブル
    op.create_table('encrypted_data',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=False),
        sa.Column('data_category', postgresql.ENUM('profile', 'analysis', 'goals', 'progress', 'communication', 'performance', 'personal', name='datacategory'), nullable=False),
    ...
    op.create_table('privacy_settings',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=False),
        sa.Column('profile_visibility', postgresql.ENUM('public', 'team', 'private', 'confidential', name='privacylevel'), nullable=True),
        sa.Column('analysis_visibility', postgresql.ENUM('public', 'team', 'private', 'confidential', name='privacylevel'), nullable=True),
        sa.Column('goals_visibility', postgresql.ENUM('public', 'team', 'private', 'confidential', name='privacylevel'), nullable=True),
        sa.Column('progress_visibility', postgresql.ENUM('public', 'team', 'private', 'confidential', name='privacylevel'), nullable=True),
        sa.Column('communication_visibility', postgresql.ENUM('public', 'team', 'private', 'confidential', name='privacylevel'), nullable=True),
    ...
    op.create_table('privacy_audit_logs',
        ...
        sa.Column('data_category', postgresql.ENUM('profile', 'analysis', 'goals', 'progress', 'communication', 'performance', 'personal', name='datacategory'), nullable=True),
